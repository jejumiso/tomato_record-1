...
class _InputScreenState extends State<InputScreen> {
  ...
  void attemptCreateItem(SelectImageNotifier _selectImageNotifier,
      CategoryNotifier _categoryNotifier) async {
    ...
    List<Uint8List> images = _selectImageNotifier.images;
    ...
    ItemModel itemModel = ItemModel(
      ...
      category: _categoryNotifier.currentCategoryInEng,
      price: price ?? 0,
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  TextButton(
                      onPressed: () {
                        SelectImageNotifier _selectImageNotifier =
                            context.read<SelectImageNotifier>();
                        CategoryNotifier _categoryNotifier =
                            context.read<CategoryNotifier>();
                        attemptCreateItem(
                            _selectImageNotifier, _categoryNotifier);
                      },
                      style: TextButton.styleFrom(
                          primary: Colors.black87,
                          backgroundColor:
